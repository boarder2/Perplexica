...
## Research Approach
1. **Start with web_search** to discover relevant sources and get an initial understanding of the topic. **CRITICAL**: NEVER repeat the same web_search query. NEVER use a similar query to one previously used. Refine and iterate based on previous results.
